                ...
                <div className="projectContainer">
                    ...
                    <div className="projGridItemInfo">
                        ...
                        <p className="projInfo">
                            ...
                            and answers. Built using Python, HTML, CSS, JavaScript, and other technologies. Click on the logo for the GitHub, and <strong><a href="http://pytutor.ddns.net/">here</a> </strong>
                             for the website Pytutor. This project has been used for CS 220, Introduction to Python Programming I, at the University of Wisconsin-Madison.
                        </p>
                    </div>
                    ...
                    <div className="projGridInfoItem">
                        <p className="projInfo">
                            ...
                            and interactivity to it. This React Page was built over Fall Semester 2020, and is still in development. I aim to learn more about the powers of React and CSS animations to add
                    ...
                    <h2 className="projectHeader">KForms</h2>
                    <div className="projectGridItemInfo">
                        <a href="https://github.com/eric-zhou2001/KForms"><p className="projItem">In-Progress!</p></a>
                        <p className="projInfo">
                            Started initially by a Hackathon by a small Web Development community, a group of friends (Sangone Jung, Franklin Wang, and I) decided to take our project further.
                            We are aiming to create a web-application that hosts easy to make forms for clubs and organizations to use. You can upload videos, photos, and textboxes for question
                            fields. We hope to get this project up and running soon!
                        </p>
                    </div>
                </div>
            </div>
